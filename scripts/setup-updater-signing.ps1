...
Write-Host "   $keyPath"
Write-Host "2. Add GitHub Actions secrets on lspectraa/Texture-Manager-2:"
Write-Host "   TAURI_SIGNING_PRIVATE_KEY = full contents of the private key file"
Write-Host "   TAURI_SIGNING_PRIVATE_KEY_PASSWORD = (leave empty if you used an empty password)"
