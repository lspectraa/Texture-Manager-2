...
impl<'a> VariantStrIter<'a> {
    ...
    fn impl_get(&self, i: usize) -> &'a str {
        unsafe {
            // RUSTSEC-2024-0429 / GHSA-wrw7-89jp-8q8g: g_variant_get_child writes
            // the out-pointer in place. Passing `&p` is unsound; rustc then
            // discards the write under optimization and CStr::from_ptr sees NULL.
