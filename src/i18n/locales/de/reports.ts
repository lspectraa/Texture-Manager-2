const reports = {
  panelTitle: "Ausgabe",
  viewRunOutput: "Ausführungsergebnis anzeigen",
  ...
  progress: {
    ...
    remaining: "Verbleibende Zeit (geschätzt): {{time}}",
    remainingEstimating: "Verbleibende Zeit (geschätzt): wird berechnet…",
    cancel: "Abbrechen",
  },
  alerts: {
