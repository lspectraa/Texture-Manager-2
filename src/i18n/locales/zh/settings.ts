const settings = {
  title: "设置",
  description: "更改应用外观、找到 Geometry Dash，并设置工具默认项。",
  statusAria: "设置状态",
  themeChip: "{{theme}} 主题",
  ...
  background: {
    ...
    defaultMeta: "默认",
    opacity: "背景不透明度",
    noneFound: "还没有找到游戏背景。设置 Geometry Dash 文件夹后即可加载。",
    custom: {
      label: "自定义背景",
      aria: "自定义应用背景",
      add: "添加图片",
      addTitle: "选择背景图片",
      imageFilter: "图片",
      empty: "添加自己的图片。会以灰度保存在这里。",
      removeAria: "移除 {{name}}",
    },
  },
  performance: {
    title: "性能",
    subtitle: "工具一次处理多少张图集",
    concurrentGamesheets: "一次处理的图集数",
    rangeHint: "1–64",
  },
  cache: {
    title: "缓存与数据",
    subtitle: "缓存的游戏文件存放位置",
    gameFilesRoot: "游戏文件文件夹",
    splitCache: "拆分缓存",
    openCacheFolder: "打开缓存文件夹",
    regenerateSpriteIndex: "重新生成精灵索引",
    regenerateSpriteIndexHint:
      "只重建你已经编过索引的图集列表。不会扫描整个游戏文件夹。",
    resetDefaults: "恢复默认值",
  },
  geometryDash: {
    title: "Geometry Dash",
