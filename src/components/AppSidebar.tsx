...
export function AppSidebar({
  ...
  return (
    ...
    >
      <GlassFrost />
      {/*
        Chrome clips scroll + footer to the glass shape. Frost stays a sibling so
        overflow:hidden here does not kill WebView2 backdrop-filter.
      */}
      <div className="tm-sidebar-chrome">
