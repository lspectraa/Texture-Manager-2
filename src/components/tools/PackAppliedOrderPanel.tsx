            ...
            return (
              ...
              >
                ...
                {!mobileShell ? (
                  <button
                    type="button"
                    className="tm-pack-applied-grip"
                  ...
                  <div className="tm-pack-applied-mobile-move">
                    <button
                      type="button"
                      className="tm-pack-applied-move-btn"
                      aria-label={t("packInstaller.appliedMoveUpAria")}
                      disabled={index === 0}
                      onClick={() => updateEntries(moveEntry(bridge.appliedEntries, index, index - 1))}
                    >
                      <ChevronUp size={14} />
                    </button>
                    <button
                      type="button"
                      className="tm-pack-applied-move-btn"
                      aria-label={t("packInstaller.appliedMoveDownAria")}
                      disabled={index === bridge.appliedEntries.length - 1}
                      onClick={() => updateEntries(moveEntry(bridge.appliedEntries, index, index + 1))}
                    >
                      <ChevronDown size={14} />
                    </button>
            ...
            {availablePacks.map((pack) => {
              ...
              return (
                <PackLibraryDragSurface
                  key={pack.id}
                  as="li"
                  className="tm-pack-applied-available-item"
                  pack={pack}
                >
